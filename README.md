...
* вывод поля со страхами, которые появляются и прячутся:
  * **усложненная версия:** появляется сразу много страхов, все физично двигаются, убивать все как можно быстрее (не каунтдаун времени, а секундомер с увеличением времени и отсрелом всего, что на экране). Важно сделать тут удобный UI/UX;
